namespace Sortable_Collection.Tests
{
    ...
    public class InterpolationSearchTests
    {
        ...
        [TestMethod]
        public void TestInterpolationWithEmptyCollectionShouldReturnMissingElement()
        {
        ...
        [TestMethod]
        public void TestInterpolationWithMissingElement()
        {
        ...
        [TestMethod]
        public void TestInterpolationWithItemAtMidpoint()
        {
        ...
        [TestMethod]
        public void TestInterpolationWithItemToTheLeftOfMidpoint()
        {
            var collection = new SortableCollection<int>(1, 2, 3, 4, 5);
        ...
        [TestMethod]
        public void TestInterpolationWithItemToTheRightOfMidpoint()
        {
            var collection = new SortableCollection<int>(1, 2, 3, 4, 5);
        ...
        [TestMethod]
        public void TestInterpolationWithMultipleMissingKeysSmallerThanMinimum()
        {
        ...
        [TestMethod]
        public void TestInterpolationWithMultipleMissingKeysLargerThanMaximum()
        {
            const int NumberOfChecks = 10000;
            const int NumberOfElements = 1000;
        ...
        [TestMethod]
        public void TestInterpolationWithMultipleKeys()
        {
        ...
        [TestMethod]
        public void TestInterpolationWithRepeatingItemShouldReturnFirstDiscoveredIndex()
        {
            var collection = new SortableCollection<int>(0, 3, 3, 3, 3, 3, 3, 7, 7, 7, 7, 7, 7);
            var result = collection.InterpolationSearch(3);
